 ...
 * @returns todas las reservas de un usuario (por idUsuario)
 */
...
async function addReservation(reservation) {
	...
	reservation.itemsRepairs = reservation.itemsRepairs.map((item) => ({...item,_id: ObjectId(item._id),}));
